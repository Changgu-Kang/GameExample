...
class ShootingGame:
	def __init__(self):
		...
		self.canvas.create_text(720,800,fill="white",font="Times 20 italic bold",text="Shooting Game Example")
		self.canvas.create_text(720,840,fill="white",font="Times 20 italic bold",text="School of computer engineering, Gyeongsang National Universityty")
